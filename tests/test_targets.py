...
# Ensure deterministic body weight for macro tests
os.environ["CALTRACK_BODY_WEIGHT_LBS"] = "189.3"
...
class TestTargetsFromExpenditure:
    ...
    def test_average_day(self) -> None:
        ...
        targets = compute_targets_from_expenditure(exp)
        ...
        assert targets.target_protein_g == 189
...
class TestEstimatedTargets:
    ...
    def test_estimate_defaults(self) -> None:
        ...
        targets = compute_estimated_targets("2026-07-28")
    ...
    def test_custom_deficit(self) -> None:
        ...
        targets = compute_estimated_targets("2026-07-28", deficit=-500)
